...
<template>
 <div id="app" class="app-container">
    ...
    <div class="product-right">
     <div v-for="(contentproduct, index) in filteredcontentproducts" :key="index" class="product-card-right" data-aos="zoom-in">
        <img :src="contentproduct.image" :alt="contentproduct.category" />
      </div>
    </div>

    <div class="product-display">
       <div v-for="(product,index) in filteredproducts" :key="index" class="product-card" data-aos="zoom-in">
